...
The current cached Durham run has 135,088 input records. It returned 115,919
automatic matches, 10 review records, and 19,159 unmatched records. Every one
of the 19,159 unmatched records had **zero blocked candidates**, so these are
...
| Diagnostic | Records |
| --- | ---: |
| Unmatched rows with zero blocked candidates | 19,159 |
...
| House number is `0` | 1,422 |
| House number is missing | 98 |
| Source address contains `/` (likely an intersection) | 2,364 |
| Non-intersection street exists in prepared TIGER data | 6,506 |
| Non-intersection street exists, but no prepared house is within +/-25 | 6,506 |
| No exact non-intersection street exists in prepared TIGER data | 10,309 |
